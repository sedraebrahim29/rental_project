...
class EditPropertyScreen extends StatelessWidget {
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              ...
                              ...cubit.existingImages.map((url) => _buildImageThumbnail(
                                imageProvider: NetworkImage(url),
                                onDelete: () => cubit.removeExistingImage(url),
                              )),

                              // 2. New Images (Local Files)
                              ...cubit.newImages.map((file) => _buildImageThumbnail(
  ...
  // Helper  for Images
  Widget _buildImageThumbnail({required ImageProvider imageProvider, required VoidCallback onDelete}) {
    return Stack(
      children: [
        Container(
          height: 100,
