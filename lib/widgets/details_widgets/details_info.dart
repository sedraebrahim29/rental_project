...
import 'package:rent/cubit/favorite_state.dart';
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // ADDRESS DETAILS
          Text(
            '${t.address_details} : ${widget.apartment.address}',
            style: const TextStyle(
              fontSize: 16,
          ...
          //price
          Text(
            '\$${widget.apartment.price}  ${t.per_night}',
            style: TextStyle(
              fontSize: 22,
              fontWeight: FontWeight.bold,
              color: MyColor.deepBlue,
          ...
          Row(
            children: [
              ...
              Text(
                '${t.baths} : ${widget.apartment.baths}',
                style: TextStyle(
                  fontSize: 15,
                  fontWeight: FontWeight.bold,
                  color: MyColor.deepBlue,
                        ...
                        return Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              Text(widget.apartment.amenities[index]),
                            ],
                          ),
                        );
                      },
                    ...
                    builder: (context) {
                      ...
                      return BlocProvider(
                        ...
                        child: BookingBottomSheet(
                          apartmentId: int.parse(widget.apartment.id!),
                          pricePerNight: widget.apartment.price,
                        ),
                      );
                    },
                  );
